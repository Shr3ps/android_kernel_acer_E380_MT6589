...
#add by NavyGuo for Acer task manager.
#Please open SIMCOM_TASK_MANAGER_SUPPORT=yes with this function.
TASK_MANAGER_IN_RECENTS_ACTIVITY = no

# 省电模式部分功能开关，默认关闭
MMI_SUPPORT_POWERSAVE_MODE = yes

#add by wentao for quick touch support 
