...
#define FLASH_BV_THRESHOLD1 0x48
#define FLASH_BV_THRESHOLD2 0x60
...
static void GC2035_Sensor_Init(void)
{
	...
	GC2035_write_cmos_sensor(0xf8 , 0x84); //0x87 0319 punk 85->83  
	GC2035_write_cmos_sensor(0xfe , 0x00);
...
GC2035_write_cmos_sensor(0x05,0x01);//hb
		...
		GC2035_write_cmos_sensor(0x08,0x3e);
		GC2035_SET_PAGE1;
		...
		GC2035_write_cmos_sensor(0x2b,0x04);//level2
		GC2035_write_cmos_sensor(0x2c,0x90);
		GC2035_write_cmos_sensor(0x2d,0x04);//6e8//level3  08
		GC2035_write_cmos_sensor(0x2e,0x90);//a2
	...
	GC2035_write_cmos_sensor(0xfe , 0x00);
	//ratio
GC2035_write_cmos_sensor(0xad , 0x80);  //0x , 0x , 0x , 0x , 0x 
	GC2035_write_cmos_sensor(0xae , 0x80); //AEC enable
...
*/
	...
	GC2035_write_cmos_sensor(0xc2 , 0xf8);//fc
	GC2035_write_cmos_sensor(0xc3 , 0x08);//05
	GC2035_write_cmos_sensor(0xc4 , 0x00);//ec
	GC2035_write_cmos_sensor(0xc5 , 0x3f);//42
	GC2035_write_cmos_sensor(0xc6 , 0xf8);
	
	GC2035_write_cmos_sensor(0xc7 , 0x44);//for cwf   40
	GC2035_write_cmos_sensor(0xc8 , 0xf8);//f8
	GC2035_write_cmos_sensor(0xc9 , 0x08);//06
	GC2035_write_cmos_sensor(0xca , 0x00);
	GC2035_write_cmos_sensor(0xcb , 0x3f);//3//3e
	GC2035_write_cmos_sensor(0xcc , 0xf8);
	
	GC2035_write_cmos_sensor(0xcd , 0x44);//for A
	GC2035_write_cmos_sensor(0xce , 0xf8);
	GC2035_write_cmos_sensor(0xcf , 0x08);
	GC2035_write_cmos_sensor(0xe3 , 0x00);
	GC2035_write_cmos_sensor(0xe4 , 0x3f);
	GC2035_write_cmos_sensor(0xe5 , 0xf8);
	GC2035_write_cmos_sensor(0xfe , 0x00);
	//===awb
	//AWB clear
	GC2035_write_cmos_sensor(0xfe , 0x01);
	...
	GC2035_write_cmos_sensor(0x4e , 0x00);//10
	GC2035_write_cmos_sensor(0x4d , 0x72);
	GC2035_write_cmos_sensor(0x4e , 0x00);//20
	GC2035_write_cmos_sensor(0x4f , 0x01);*/
	...
	GC2035_write_cmos_sensor(0x4e , 0x00);                         
	GC2035_write_cmos_sensor(0x4e , 0x00);                         
	GC2035_write_cmos_sensor(0x4e , 0x00);  //04                       
	GC2035_write_cmos_sensor(0x4e , 0x34);                         
	GC2035_write_cmos_sensor(0x4e , 0x02);//d65                                           
	GC2035_write_cmos_sensor(0x4d , 0x40); ////////////40          
	GC2035_write_cmos_sensor(0x4e , 0x00);                         
	GC2035_write_cmos_sensor(0x4e , 0x00);                         
	GC2035_write_cmos_sensor(0x4e , 0x34);                         
	GC2035_write_cmos_sensor(0x4e , 0x34); //cwf                   
	GC2035_write_cmos_sensor(0x4e , 0x02);//cwf  d50               
	...
	GC2035_write_cmos_sensor(0x4e , 0x00);                         
	GC2035_write_cmos_sensor(0x4e , 0x00);                         
	GC2035_write_cmos_sensor(0x4e , 0x00);//a                      
	GC2035_write_cmos_sensor(0x4e , 0x00);//a                                               
	GC2035_write_cmos_sensor(0x4d , 0x90); ////////////////90      
	GC2035_write_cmos_sensor(0x4e , 0x00);                         
	GC2035_write_cmos_sensor(0x4e , 0x00);                         
	...
	GC2035_write_cmos_sensor(0xfe , 0x00);
	GC2035_write_cmos_sensor(0x82 , 0x02);//awb_en   02s
	...
	////===dndd
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x88 , 0x1f);
	GC2035_write_cmos_sensor(0x8c , 0xf6); 
	GC2035_write_cmos_sensor(0x89 , 0x01); //dn_c_weight  03

	//  EE
	GC2035_write_cmos_sensor(0xfe , 0x02);
	GC2035_write_cmos_sensor(0x90 , 0x6c);// EEINTP mode1  6c
	GC2035_write_cmos_sensor(0x97 , 0x47);// edge effect  45
	////==============RGB Gamma 
	GC2035_write_cmos_sensor(0xfe , 0x02);
...
BOOL GC2035_set_param_banding(UINT16 para)
{
    switch (para)
    {
		...
		GC2035_write_cmos_sensor(0x05,0x02);//hb
		GC2035_write_cmos_sensor(0x06,0x0c);
		GC2035_write_cmos_sensor(0x07,0x00);//vb
		GC2035_write_cmos_sensor(0x08,0xc5);
		GC2035_SET_PAGE1;
		GC2035_write_cmos_sensor(0x27,0x00);//step
		GC2035_write_cmos_sensor(0x28,0x9d);
		GC2035_write_cmos_sensor(0x29,0x06);//level1
		GC2035_write_cmos_sensor(0x2a,0x22);
		GC2035_write_cmos_sensor(0x2b,0x07);//level2
		GC2035_write_cmos_sensor(0x2c,0x5c);
		GC2035_write_cmos_sensor(0x2d,0x08);//level3
		GC2035_write_cmos_sensor(0x2e,0x96);
		GC2035_write_cmos_sensor(0x2f,0x09);//level4
		GC2035_write_cmos_sensor(0x30,0x33);
		GC2035_SET_PAGE0;
            break;
...
BOOL GC2035_set_param_exposure(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AE_EV_COMP_00:
			GC2035_SET_PAGE1;
			GC2035_write_cmos_sensor(0x13,0x76);  // 0x68   zyx : 0x78/0x80  78 84
			GC2035_SET_PAGE0;
		break;
		case AE_EV_COMP_03:
			GC2035_SET_PAGE1;
...
static void GC2035_YUV_FlashTriggerCheck(unsigned int *pFeatureReturnPara32)
{
    unsigned int pregain1,postgain2;
	
    //printk("GC2035_YUV_FlashTriggerCheck\n");
		
    pregain1 = GC2035_read_cmos_sensor(0xb1);
    postgain2 = GC2035_read_cmos_sensor(0xb2);

    printk("GC2035_YUV_FlashTriggerCheck: pregain1=%x, postgain2=%x\n",pregain1,postgain2);

    if ((pregain1 > FLASH_BV_THRESHOLD1)&&(postgain2 > FLASH_BV_THRESHOLD2))
    {
       *pFeatureReturnPara32 = TRUE;

    printk("GC2035_YUV_FlashTriggerCheck: pFeatureReturnPara32 1 =%d\n",*pFeatureReturnPara32);
    ...
    *pFeatureReturnPara32 = FALSE;
    ...
    printk("GC2035_YUV_FlashTriggerCheck: pFeatureReturnPara32 2=%d\n",*pFeatureReturnPara32);
							 ...
							 UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
	...
	switch (FeatureId)
	{
        ...
        case SENSOR_FEATURE_GET_TRIGGER_FLASHLIGHT_INFO:
             GC2035_YUV_FlashTriggerCheck(pFeatureData32);
             SENSORDB("[GC2035] F_GET_TRIGGER_FLASHLIGHT_INFO: %d\n", pFeatureData32);
             break;			   
		default:
			break;			
	}
