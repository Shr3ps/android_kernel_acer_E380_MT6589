...
//                MtkCameraParameters::SCENE_MODE_NORMAL, 
...
#endif
    //==========================================================================
#if defined(ACER_C17)	//20131209,qiaoxiujun
    ...
    FTABLE_CONFIG_AS_TYPE_OF_DEFAULT_VALUES(
        ...
        SCENE_AS_DEFAULT_SCENE(
            ...
            ITEM_AS_VALUES_(
                "1024x768",     "1280x720",     "2112x1584",    "2304x1296",    "2560x1920",    "3072x1728",
		"3264x2448",    "3840x2160",	"3712x2784",	"4352x2448",	"4224x3168",	"4864x2736"
            )
        ), 
    )	
#else
