...
#define CUST_EINT_KPD_SLIDE_DEBOUNCE_CN      32
#define CUST_EINT_KPD_SLIDE_POLARITY         CUST_EINT_POLARITY_LOW
#define CUST_EINT_KPD_SLIDE_SENSITIVE        CUST_EINT_LEVEL_SENSITIVE
#define CUST_EINT_KPD_SLIDE_DEBOUNCE_EN      CUST_EINT_DEBOUNCE_ENABLE
